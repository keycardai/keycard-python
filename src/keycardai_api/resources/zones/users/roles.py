...
from ....types.zones.users import role_list_params, role_assign_params, role_revoke_params
from ....types.zones.users.role_assignment import RoleAssignment
from ....types.zones.users.role_list_response import RoleListResponse
...
class RolesResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        """Returns the roles assigned to the specified user within the zone.
        ...
        return self._get(
            path_template("/zones/{zone_id}/users/{user_id}/roles", zone_id=zone_id, user_id=user_id),
    ...
    def assign(
        ...
        *,
        ...
        Provide exactly one of role_id or role_identifier;
    ...
    def revoke(
        ...
        *,
        ...
        return self._delete(
            path_template(
                "/zones/{zone_id}/users/{user_id}/roles/{role_id}", zone_id=zone_id, user_id=user_id, role_id=role_id
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
