...
class KeycardAPI(SyncAPIClient):
    ...
    def auth_headers(self) -> dict[str, str]:
        return {**self._svc_org_management_basic_auth, **self._vault_bearer_auth}

    @property
    def _svc_org_management_basic_auth(self) -> dict[str, str]:
    ...
    @property
    def _vault_bearer_auth(self) -> dict[str, str]:
