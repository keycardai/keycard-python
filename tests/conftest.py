...
from keycard_api import KeycardAPI, AsyncKeycardAPI, DefaultAioHttpClient
from keycard_api._utils import is_dict
...
logging.getLogger("keycard_api").setLevel(logging.DEBUG)
