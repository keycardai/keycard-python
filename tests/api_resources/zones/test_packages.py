...
from keycardai_api.types.zones import Package, PackageList, PackageDraft
...
class TestPackages:
    ...
    def test_method_list(self, client: KeycardAPI) -> None:
        package = client.zones.packages.list(
            zone_id="zone_id",
        )
        assert_matches_type(PackageList, package, path=["response"])
    ...
    def test_method_list_with_all_params(self, client: KeycardAPI) -> None:
        package = client.zones.packages.list(
            ...
            after="x",
            before="x",
            filters_slug="lkfwmkifjr:4mtu9913w4",
            kind="kind",
            limit=1,
            x_client_request_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_raw_response_list(self, client: KeycardAPI) -> None:
        response = client.zones.packages.with_raw_response.list(
            zone_id="zone_id",
        )
    ...
    def test_streaming_response_list(self, client: KeycardAPI) -> None:
        with client.zones.packages.with_streaming_response.list(
            zone_id="zone_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: KeycardAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.zones.packages.with_raw_response.list(
                zone_id="",
            )

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_retrieve_draft(self, client: KeycardAPI) -> None:
        package = client.zones.packages.retrieve_draft(
            package_id="lkfwmkifjr:4mtu9913w4",
            zone_id="zone_id",
        )
        assert_matches_type(PackageDraft, package, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_retrieve_draft_with_all_params(self, client: KeycardAPI) -> None:
        package = client.zones.packages.retrieve_draft(
            package_id="lkfwmkifjr:4mtu9913w4",
            zone_id="zone_id",
            x_client_request_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_retrieve_draft(self, client: KeycardAPI) -> None:
        response = client.zones.packages.with_raw_response.retrieve_draft(
            package_id="lkfwmkifjr:4mtu9913w4",
            zone_id="zone_id",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_retrieve_draft(self, client: KeycardAPI) -> None:
        with client.zones.packages.with_streaming_response.retrieve_draft(
            package_id="lkfwmkifjr:4mtu9913w4",
            zone_id="zone_id",
        ) as response:
            assert not response.is_closed
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_retrieve_draft(self, client: KeycardAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.zones.packages.with_raw_response.retrieve_draft(
                package_id="lkfwmkifjr:4mtu9913w4",
                zone_id="",
            )
...
class TestAsyncPackages:
    ...
    async def test_method_list(self, async_client: AsyncKeycardAPI) -> None:
        package = await async_client.zones.packages.list(
            zone_id="zone_id",
        )
        assert_matches_type(PackageList, package, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncKeycardAPI) -> None:
        response = await async_client.zones.packages.with_raw_response.list(
            zone_id="zone_id",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncKeycardAPI) -> None:
        async with async_client.zones.packages.with_streaming_response.list(
            zone_id="zone_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncKeycardAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.zones.packages.with_raw_response.list(
                zone_id="",
            )

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_retrieve_draft(self, async_client: AsyncKeycardAPI) -> None:
        package = await async_client.zones.packages.retrieve_draft(
            package_id="lkfwmkifjr:4mtu9913w4",
            zone_id="zone_id",
        )
        assert_matches_type(PackageDraft, package, path=["response"])
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_retrieve_draft_with_all_params(self, async_client: AsyncKeycardAPI) -> None:
        package = await async_client.zones.packages.retrieve_draft(
            package_id="lkfwmkifjr:4mtu9913w4",
            zone_id="zone_id",
            x_client_request_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_retrieve_draft(self, async_client: AsyncKeycardAPI) -> None:
        response = await async_client.zones.packages.with_raw_response.retrieve_draft(
            package_id="lkfwmkifjr:4mtu9913w4",
            zone_id="zone_id",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_retrieve_draft(self, async_client: AsyncKeycardAPI) -> None:
        async with async_client.zones.packages.with_streaming_response.retrieve_draft(
            package_id="lkfwmkifjr:4mtu9913w4",
            zone_id="zone_id",
        ) as response:
            assert not response.is_closed
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_retrieve_draft(self, async_client: AsyncKeycardAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.zones.packages.with_raw_response.retrieve_draft(
                package_id="lkfwmkifjr:4mtu9913w4",
                zone_id="",
            )
