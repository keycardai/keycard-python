...
class TestUserAgents:
    ...
    def test_method_retrieve(self, client: KeycardAPI) -> None:
        ...
        assert_matches_type(UserAgent, user_agent, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_retrieve(self, client: KeycardAPI) -> None:
        response = client.zones.user_agents.with_raw_response.retrieve(
            id="id",
            zone_id="zoneId",
        )
    ...
    def test_streaming_response_retrieve(self, client: KeycardAPI) -> None:
        with client.zones.user_agents.with_streaming_response.retrieve(
            id="id",
            zone_id="zoneId",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: KeycardAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.zones.user_agents.with_raw_response.retrieve(
                id="id",
                zone_id="",
            )
    ...
    def test_method_list(self, client: KeycardAPI) -> None:
        user_agent = client.zones.user_agents.list(
            "zoneId",
        )
        assert_matches_type(UserAgentListResponse, user_agent, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_list(self, client: KeycardAPI) -> None:
        response = client.zones.user_agents.with_raw_response.list(
            "zoneId",
        )
    ...
    def test_streaming_response_list(self, client: KeycardAPI) -> None:
        with client.zones.user_agents.with_streaming_response.list(
            "zoneId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: KeycardAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            client.zones.user_agents.with_raw_response.list(
                "",
            )
...
class TestAsyncUserAgents:
    ...
    async def test_method_retrieve(self, async_client: AsyncKeycardAPI) -> None:
        user_agent = await async_client.zones.user_agents.retrieve(
            id="id",
            zone_id="zoneId",
        )
        assert_matches_type(UserAgent, user_agent, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncKeycardAPI) -> None:
        response = await async_client.zones.user_agents.with_raw_response.retrieve(
            id="id",
            zone_id="zoneId",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncKeycardAPI) -> None:
        async with async_client.zones.user_agents.with_streaming_response.retrieve(
            id="id",
            zone_id="zoneId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncKeycardAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.zones.user_agents.with_raw_response.retrieve(
                id="id",
                zone_id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncKeycardAPI) -> None:
        user_agent = await async_client.zones.user_agents.list(
            "zoneId",
        )
        assert_matches_type(UserAgentListResponse, user_agent, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncKeycardAPI) -> None:
        response = await async_client.zones.user_agents.with_raw_response.list(
            "zoneId",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncKeycardAPI) -> None:
        async with async_client.zones.user_agents.with_streaming_response.list(
            "zoneId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncKeycardAPI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `zone_id` but received ''"):
            await async_client.zones.user_agents.with_raw_response.list(
                "",
            )
